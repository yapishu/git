...
- verified, incremental native forks with explicit pull-from-origin refresh: Ames coordinates access and refs while bounded sequential Fine pages carry only the missing immutable object snapshot; duplicate requests coalesce and active transfers can be cancelled
